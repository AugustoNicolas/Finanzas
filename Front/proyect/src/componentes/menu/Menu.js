...
class Menu extends React.Component {
   ...
   render() {
     ...
     return (
      <nav className="navbar navbar-expand-lg" style={styles.bd}>
         <div className="container-fluid ">
            <Link to="/" className="navbar-brand text-white" href="#">MyMoney</Link>
            <button className="navbar-toggler  bg-light" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
               <span className="navbar-toggler-icon" style={styles.toggleIcon}>↓</span>
            </button>
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
               <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                  ...
                  <li className="nav-item">
                     <NavLink to="/nosotros" className="nav-link text-white">Nosotros</NavLink>
                  </li>
                  <li className="nav-item">
